...
class emaillocalpartrandomnumber implements username_format_interface {
    ...
    public function get_name() : string {
        return get_string('emaillocalpartrandomnumber', 'enrol_arlo');
    }
    ...
    public function get_shortname() : string {
        return 'emaillocalpartrandomnumber';
    }
    ...
    public function get_description() : string {
        return get_string('emaillocalpartrandomnumber_desc', 'enrol_arlo');
    }
